...
<p align="center">
  ...
  <img src="https://tc.tigase.net/app/rest/builds/buildType:(id:TigaseHttpApiTheming_Build)/statusIcon" width="100"/>
</p>

# What it is

Tigase HTTP API - Theming is a repository for theme used by Tigase HTTP API and its modules, ie. Admin UI.
